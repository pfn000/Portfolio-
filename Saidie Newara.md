...
<img width="128" height="128" alt="image" src="https://github.com/user-attachments/assets/b41726ce-70d6-47ad-b00a-e3863db40a5c" />
...
**Highschool** | 2017 PA Homeschooling PA
Homeschoolers Assosation Program 3.5 GPA

### Collage  
 5 years collage exp BC3 Cranberry Twp - Genral Studies ~ 2017 - 2018

left-Trans to 4 year batcholors degree Landmark Collage Putney Vermont - 
**BC3** | Cranberry Township , PA 
![BC3 Logo](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDlPR9Lcipi8cqTUpbKllyydRHJwau2Zlb0w&s)
 Genral Studies 2017 - 2018 Left -> to Landmark
 
--
**Landmark Collage** | Putney , Vermont 

![Landmark Logo](https://ymgrad.com/media/logo/landmark-removebg-preview.png)

General Studies ~ 2018 [ Transition ] 
-- 

**Ave Maria University** | Ave Maira , FL 
![Ave Maria Logo](https://upload.wikimedia.org/wikipedia/en/6/65/Ave_maria_univ_seal.png)
...
**St. Ferdinand [ `Divine Grace Parish`]** | Youth Minatry [ `Hosaina Indastrys` - habitat for humanitys based non-for-profit org
- Went around Pittsburg community and local areas in repairing, restoring, cleaning homeowners that needed help or could not afford "getting" help

**Ave Maria University FL** Ave Maria University Volunteer FireFighter [ `On Campus Fire Marchal assistent` ]
...
**Projects PleX Code** | Writing my own Programming Language from scratch full sovrent not based off existing code.

![PleX Logo](https://github.com/pfn000/PleX/blob/main/Assets/Images/PleX%20code.png)
...
**Nude** | A Backend logic protocal based from Node Javascript where it is not only fully modular backend SDK but a self-snapping logic call built fully from PleX code.
...
Performed custom 3D Modeling Commissions through Fiveer.com
Tools I used|
- Unity 2019 - 2024
...
*EmmiCO** `Virtual Content Creator , [VTuber ]` |  Pittsburgh, PA REMOTE **Feb 2020 - May 2023** 

![Emmi_Official](https://onuniverse-assets.imgix.net/78e73805-7e0d-42db-8189-395a0f61c349?fit=clip&auto=compress,format&w=200&q=65)
